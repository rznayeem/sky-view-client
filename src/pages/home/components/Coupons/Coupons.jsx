            ...
            >
              {coupons.map(coupon => (
                <SwiperSlide key={coupon._id}>
                  <div className="relative flex justify-between items-center py-14 px-7 bg-gradient-to-b from-[#CD8C66] via-[#CD8C66]/[.8] to-[#CD8C66] rounded-3xl bg-no-repeat bg-[center]">
                    <div
